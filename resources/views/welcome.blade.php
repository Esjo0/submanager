            ...
            <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
              ...
              <div class="card card-plain mt-8">
                <div class="card-header pb-0 text-left bg-transparent">
                    <div class="row">
                        ...
                        @foreach ($keys as $key)
                            <div class="col-sm-4">
                                ...
                                href="{{ route('subscribers', ['id' => $key->id]) }}"
                                >{{ $key->title }}</a>
                            </div>
                        @endforeach
                        @else
                  ...
                  <p class="mb-0">Enter your API key and your preffer key title</p>
                  @include('common.alert')
                </div>
                <div class="card-body">
                  <form role="form" method="post" action="{{ route('check') }}">
                    @csrf
                    <label>Key Title</label>
                    <div class="mb-3">
                      <input name="title" type="text" class="form-control" placeholder="Title" aria-label="Title" aria-describedby="" required>
                    </div>
                    <label>API Key</label>
                    <div class="mb-3">
                        <textarea name="api_key" class="form-control" required></textarea>
                    </div>
